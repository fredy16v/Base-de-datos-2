        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProyectoEmpleados_empleados_EmpleadoId",
                        column: x => x.EmpleadoId,
                        principalTable: "empleados",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProyectoEmpleados_proyectos_ProyectoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProyectoEmpleados_EmpleadoId",
                table: "ProyectoEmpleados",
                column: "EmpleadoId");

            migrationBuilder.CreateIndex(
                name: "IX_ProyectoEmpleados_ProyectoId",
                table: "ProyectoEmpleados",
                column: "ProyectoId");
        }
